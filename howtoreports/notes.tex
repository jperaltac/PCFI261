...
\title[PCFI261 -- C\'omo hacer reportes]{Modelos Computacionales PCFI261\\C\'omo escribir el informe del curso}
\subtitle{Gu\'ia para informes manuscritos}
\author[PCFI261]{Modelos Computacionales para F\'isica y Astronom\'ia}
\institute{Universidad Andr\'es Bello}
\titlegraphic{\hfill\includegraphics[height=1.8cm]{../week01/logo-unab.jpg}}
\date{\today}
