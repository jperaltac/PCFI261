...
El salto importante no es solo usar una red, sino pasar de reglas explicitamente programadas a modelos que ajustan su representacion usando datos.
\end{block}

\column{0.40\textwidth}
\begin{center}
\includegraphics[width=\linewidth]{Figuras/washing.jpeg}
\end{center}
\end{columns}
...
\inputminted[firstline=8,lastline=43,fontsize=\tiny]{python}{codes/stellar_catalog_mlp.py}
\end{frame}

\begin{frame}[fragile]{Codigo principal: arquitectura y entrenamiento}
\inputminted[firstline=45,lastline=77,fontsize=\tiny]{python}{codes/stellar_catalog_mlp.py}
\end{frame}
